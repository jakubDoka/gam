...
Ent_Stats_Attack :: struct {
	shots_per_reload_minus_one: int `cc:"leb"`,
	bullets_per_shot_minus_one: int `cc:"leb"`,
	shot_spacing:               f32 `gam:"round2"cc:"round2"`,
	spread:                     f32 `gam:"round2"cc:"round2"`,
	innaccuracy:                f32 `gam:"round2"cc:"round2"`,
	recoil:                     f32 `gam:"round"cc:"fixed"`,
	bullet:                     Ent_Stats_ID,
	unwind:                     f32 `gam:"round2"cc:"round2"`,
}

Ent_Stats :: struct {
	name:             Ent_Stats_Name `gam:"hidden"`,
	id:               Ent_Stats_ID `gam:"hidden"cc:"skip"`,
	playable:         bool,
	placable:         bool,
	guards:           bool,
	tall:             bool,
	...
	using physics:    struct {
		...
		mass_mult_minus_one:     f32 `gam:"round1"cc:"round1"`,
		absorbtion:              f32 `gam:"round"cc:"fixed"`,
		sprite:                  Asset_ID,
		spin:                    f32 `gam:"round"cc:"fixed"`,
		body_damage:             f32 `gam:"round"cc:"fixed"`,
		bounce_multiplier:       f32 `gam:"round1"cc:"round1"`,
		lifetime_multiplier:     f32 `gam:"round1"cc:"round1"`,
		hit_multiplier:          f32 `ver:"1",gam:"round1"cc:"round1"`,
		bounce_age_reduction:    f32 `gam:"round1"cc:"round1"`,
	},
	using attack:     Ent_Stats_Attack,
	dash:             struct {
		impact:   f32 `gam:"round"cc:"fixed"`,
		cooldonw: f32 `gam:"round2"cc:"round2"`,
	},
	parry:            struct {
		invincibility: f32 `gam:"round1"cc:"round1"`,
		duration:      f32,
		cooldown:      f32,
	...
	using turret:     struct {
		cannon:    Asset_ID,
		aim_speed: f32 `gam:"round1"cc:"round1"`,
		range:     f32 `gam:"round"cc:"fixed"`,
		reload:    f32 `gam:"round2"cc:"round2"`,
	},
	using health:     struct {
		energy:         f32 `gam:"round"cc:"fixed"`,
		energy_drain:   f32 `gam:"round1"cc:"round1"`,
		recharge_speed: f32 `gam:"round1"cc:"round1"`,
		bind_range:     f32 `gam:"round"cc:"fixed"`,
	},
	trail:            struct {
		spacing:           f32 `gam:"round2"cc:"round2"`,
		spawn_innaccuracy: f32 `gam:"round"cc:"fixed"`,
		quantity_per_tick: int `cc:"leb"`,
		particle:          Particle_Stats,
	},
	explosion:        struct {
		radius:                      f32 `gam:"round"cc:"fixed"`,
		on_contact:                  bool,
		damage_multiplier_minus_one: f32 `gam:"round1"cc:"round1"`,
		particle_quantity:           int `cc:"leb"`,
		particle:                    Particle_Stats,
	},
}
...
Particle_Stats :: struct {
	one_minus_radius_ratio: f32 `gam:"round1"cc:"round1"`,
	lifetime:               f32 `gam:"round2"cc:"round2"`,
	end_color:              Color,
	end_radius_ratio:       f32 `gam:"round1"cc:"round1"`,
	lifetime_variation:     f32 `gam:"round2"cc:"round2"`,
}
